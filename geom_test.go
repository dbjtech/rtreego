...
func TestNoIntersection(t *testing.T) {
	p := Point{1, 2, 3}
	lengths1 := []float32{1, 1, 1}
	rect1, _ := NewRect(p, lengths1)

	q := Point{-1, -2, -3}
	lengths2 := []float32{2.5, 3, 6.5}
	rect2, _ := NewRect(q, lengths2)
...
func TestOverlapIntersection(t *testing.T) {
	p := Point{1, 2, 3}
	lengths1 := []float32{1, 2.5, 1}
	rect1, _ := NewRect(p, lengths1)

	q := Point{1, 4, -3}
	lengths2 := []float32{3, 2, 6.5}
	rect2, _ := NewRect(q, lengths2)
...
func TestBoundingBox(t *testing.T) {
	p := Point{3.7, -2.4, 0.0}
	lengths1 := []float32{1, 15, 3}
	rect1, _ := NewRect(p, lengths1)

	q := Point{-6.5, 4.7, 2.5}
	lengths2 := []float32{4, 5, 6}
	rect2, _ := NewRect(q, lengths2)
...
func TestBoundingBoxContains(t *testing.T) {
	...
	q := Point{4.0, 0.0, 1.5}
	lengths2 := []float32{0.56, 6.222222, 0.946}
	rect2, _ := NewRect(q, lengths2)
